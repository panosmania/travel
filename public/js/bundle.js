...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicGFub3NtYW5pYSIsImEiOiJja2IxeTIwc20wNDIxMnBzMDNkZHRsMDE1In0.R9L_bTeMwTvesj7LI2Lq5A';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/panosmania/ckb1ylbhy0lc71ilb0mtw4ogl',
...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, emailSignup, passwordSignup, passwordConfirm) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', "Invalid input data. ".concat(_context.t0.response.data.message.split(':')[2], "!"));
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:3000/api/v1/users/updateMyPasswords' : 'http://127.0.0.1:3000/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_aJnmmfH3VEATZltKSflspWBb00vKhaWqnn');
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    e.preventDefault(); //take email and password value that the user put in from the browser
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    e.preventDefault(); //take name,emailSignup,passwordSignup and passwordConfirm value that the user put in from the browser
    ...
    (0, _signup.signup)(name, emailSignup, passwordSignup, passwordConfirm);
  });
}
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    form.append('photo', document.getElementById('photo').files[0]); //console.log('maaa', form);
    // const name = document.getElementById('name').value;
    // const email = document.getElementById('email').value;
